const aboutContent = [
    ...
    {
        section: "Skillset",
        content: "I'm a multi-faceted designer with skills in UI design, prototyping, front-end development & visual design. And well-versed in design tools such as Figma, Adobe XD, Photoshop, Illustrator & After Effects. For front-end development, I have experience working with JavaScript, HTML, CSS, React and React Native."
    },
    {
        section: "Experience",
